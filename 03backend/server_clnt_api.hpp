#pragma once
/* C++ API:
	Inspired by: https://github.com/anlongfei/libaio/blob/master/src/libaio.h, #include <aio.h>
	LinuxIOuring: https://elixir.bootlin.com/linux/v6.14.5/source/tools/include/io_uring/mini_liburing.h
*/
#include <stdio.h>
...
inline void __compilation_verification(void) {
	...
	BUILD_BUG_ON(sizeof(io_request::params_t) != 56);
